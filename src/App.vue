<template>
  <div id="app">
    <vue-waveform ref="mycom" :range="0.6" :WIDTH="800" type="line" :HEIGHT="500" websocketURL="ws://192.168.6.48:8082/ws/websocket/socketServer.do" :id="selectid" :arraybuffer="arraybuffer"></vue-waveform>
